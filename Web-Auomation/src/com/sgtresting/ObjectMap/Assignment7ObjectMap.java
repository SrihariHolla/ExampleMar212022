...
public class Assignment7ObjectMap {
	...
	private static void createtask()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("CreateNewTask")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("Tasknamefield")).sendKeys("TASK-1");
			Thread.sleep(1000);
	...
	private static void deletetask()
	{
		try
		{
			oBrowser.findElement(objectmap.getLocator("Tasklist")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("TaskAction")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("TaskDelete")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("TaskDeletePermanently")).click();
			Thread.sleep(1000);
		}catch(Exception e)
		{
			e.printStackTrace();
