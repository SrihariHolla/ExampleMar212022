...
public class Assignment6ObjectMap {
	...
	private static void ModifyProject()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("ProjectModify")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("ProjectModifyName")).click();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("ProjectModifyName")).clear();
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("ProjectModifyName")).sendKeys("Modified Project");
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("ProjectSetting")).click();
			Thread.sleep(2000);
		}catch(Exception e)
