...
public class Assignment6Pom {
	...
	private static void ModifyProject()
	{
		try
		{
			...
			Thread.sleep(1000);
			oPage.getProjectModify().click();
			Thread.sleep(500);
			oPage.getProjectModifyName().click();
			Thread.sleep(1000);
			oPage.getProjectModifyName().clear();
			oPage.getProjectModifyName().sendKeys("Modified Project");
			Thread.sleep(1000);
			oPage.getProjectclose().click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
